...
// const element = document.querySelector(".block__head");
...
// 		alert("there is nothing belove zero")
// 	}
// 	else
// 		element.textContent = parseInt(element.textContent) - 1;
// })

// const button4 = document.querySelector(".button__link");
// const elem = document.querySelector(".bi-heart");
// button4.style.background = "#794f45";
...
// });
// blockForMouse.addEventListener("click", function (event) {
// 	blockForMouse.innerHTML = `click`;
// });

// const imageMain = document.querySelector(".block .block__image img");
// const image1 = document.querySelectorAll(".block__images .image img")[0];
// const image2 = document.querySelectorAll(".block__images .image img")[1];
// const image3 = document.querySelectorAll(".block__images .image img")[2];


// image1.addEventListener("mouseover", function (event) {
// 	imageMain.src = image1.src;
