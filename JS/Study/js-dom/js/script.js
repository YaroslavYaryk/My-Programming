...
// const confirmResult = confirm("Wanna learn verstka???");
// console.log(confirmResult)


// const promptResult = prompt("Who u r??");
...
// const elemsFour = document.querySelectorAll("#listItem");
// const elemsFive = document.querySelector("#listItem");
// // const elem = document.getElementById("listItem");
// // const elem = document.getElementsByTagName("li")
// // const elem = document.getElementsByClassName("lesson__list")
// const elem = document.getElementsByName("viewport")


// console.log(elemsOne[0].querySelectorAll("li"));
...
// textElement.innerHTML = `<p>${textElementContent}</p> Thats <span class='yellow'>me.</span>`;
...
// const t`extElement = document.querySelector(".content__text");
// const newElement = document.createElement("div"); 

// // newElement.innerHTML = "<h1>this is me <span class='yellow'>Ярослав.</span></h1>";

// // // textElement.before(newElement);
// // textElement.after(newElement, "me too");
// // // textElement.prepend(newElement); //в середину 
// // // textElement.append(newElement); 

// // console.log(newElement);

// newElement.insertAdjacentHTML("afterbegin", "<h1>this is me <span class='yellow'>Yaryk.</span></h1>")
// textElement.after(newElement);`


// const lesson = document.querySelector(".content__text");
// const title = document.querySelector("h3");

// const newElement = title.cloneNode(true);
